...
namespace Persons.Entities.Contexts
{
    public partial class RepositoryContext : IdentityDbContext<User>
    {
        ...
        public virtual DbSet<VPersonType> VPersonTypes { get; set; }
        public virtual DbSet<VRegionPerson> VRegionPeople { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VRegionPerson>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VRegionPerson");
            ...
            modelBuilder.Entity<VPersonType>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VPersonType");
